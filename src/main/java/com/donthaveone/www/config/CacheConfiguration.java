package com.donthaveone.www.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.donthaveone.www.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.donthaveone.www.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.donthaveone.www.domain.Flashcard.class.getName() + ".tags");
